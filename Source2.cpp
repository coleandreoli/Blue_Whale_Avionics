...
void loop() {
	...
	case 1:
		...
		update_sensor_data();
		file.print(sensor_data.time);
		file.print(",");
		file.print(sensor_data.accelerometer[0]);
		file.print(",");
		file.print(sensor_data.accelerometer[1]);
		file.print(",");
		file.print(sensor_data.accelerometer[2]);
		file.print(",");
		file.print(sensor_data.magnetometer[0]);
		file.print(",");
		file.print(sensor_data.magnetometer[1]);
		file.print(",");
		file.print(sensor_data.magnetometer[2]);
		file.print(",");
		file.print(sensor_data.gyroscope[0]);
		file.print(",");
		file.print(sensor_data.gyroscope[1]);
		file.print(",");
		file.print(sensor_data.gyroscope[2]);
		file.print(",");
		file.print(sensor_data.acc_linear[0]);
		file.print(",");
		file.print(sensor_data.acc_linear[1]);
		file.print(",");
		file.print(sensor_data.acc_linear[2]);
		file.print(",");
		file.print(sensor_data.rotation_vector[0]);
		file.print(",");
		file.print(sensor_data.rotation_vector[1]);
		file.print(",");
		file.print(sensor_data.rotation_vector[2]);
		file.print(",");
		file.print(sensor_data.rotation_vector[3]);
		file.println();
